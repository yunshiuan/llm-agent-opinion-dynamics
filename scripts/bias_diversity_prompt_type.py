...
out_name = "all_prompts_reflection.txt"
...
with open(out_name, "a") as f:
    for base in prompt_bases:
        ...
        f.write(f"Bias: {np.round(np.mean(bias_list), 2)} $\pm$ {np.round(np.std(bias_list)/np.sqrt(len(bias_list)), 2)}\t, ")
        f.write(f"Diversity: {np.round(np.mean(diversity_list), 2)} $\pm$ {np.round(np.std(diversity_list)/np.sqrt(len(diversity_list)), 2)}\n")
    ...
    for base in prompt_bases:
        ...
        f.write(f"Bias: {np.round(np.mean(bias_list), 2)} $\pm$ {np.round(np.std(bias_list)/np.sqrt(len(bias_list)), 2)}\t, ")
        f.write(f"Diversity: {np.round(np.mean(diversity_list), 2)} $\pm$ {np.round(np.std(diversity_list)/np.sqrt(len(bias_list)), 2)}\n")
